...
var dataACCT = [
        ...
        {"date": "1-Apr-18", "salary": 50000, "bonus": 6000},
        {"date": "1-Jul-18", "salary": 49000, "bonus": 5000},
        {"date": "1-Oct-18", "salary": 68000, "bonus": 6000},
        {"date": "1-Jan-19", "salary": 56000, "bonus": 6000},
        {"date": "1-Apr-19", "salary": 51000, "bonus": 6000},
        {"date": "1-Jul-19", "salary": 55000, "bonus": 4000},
        {"date": "1-Oct-19", "salary": 59000, "bonus": 6000},
        {"date": "1-Jan-20", "salary": 52000, "bonus": 5000},
        {"date": "1-Apr-20", "salary": 53000, "bonus": 6000},
        {"date": "1-Jul-20", "salary": 55000, "bonus": 3000},
        {"date": "1-Oct-20", "salary": 47000, "bonus": 6000},
        {"date": "3-Jan-21", "salary": 52000, "bonus": 3000},
        {"date": "1-Apr-21", "salary": 49000, "bonus": 6000},
        {"date": "1-Jul-21", "salary": 55000, "bonus": 4000},
        {"date": "1-Oct-21", "salary": 48000, "bonus": 6000},
...
g.selectAll("dot")
        .data(dataIS)
        .enter().append("circle")
        .filter(function(d) { return d.date.includes("Jan") && d.date != "2-Jan-18" })
        .attr("r", 5)
...
g.append("text")
        .attr("class", "pathtext")
		.attr("transform", "translate(" + (width + 45) + "," + y(dataIS[dataIS.length-1].salary + dataIS[dataIS.length-1].bonus) + ")")
		.attr("dy", "22px") // offset 4 pixels from line
...
g.append("text")
        .attr("class", "pathtext")
		.attr("transform", "translate(" + (width + 45) + "," + y(dataACCT[dataACCT.length-1].salary + dataACCT[dataACCT.length-1].bonus) + ")")
		.attr("dy", "19px") // offset 4 pixels from line
		.attr("text-anchor", "end") // to right justify, "start" to left jusitfy and "middle" to center
		.style("fill", "white")
